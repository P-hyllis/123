...
class TrecEvaluator(object):
    ...
    def predefined_msmarco_trec(self, qrels_name, trec_name):
        return {
            "map": self.calc_trec_metric("-l 2 -m map", qrels_name, trec_name) * 100,
            "ndcg@10": self.calc_trec_metric("-m ndcg_cut.10", qrels_name, trec_name) * 100,
            "ndcg@20": self.calc_trec_metric("-m ndcg_cut.20", qrels_name, trec_name) * 100,
            "ndcg@30": self.calc_trec_metric("-m ndcg_cut.30", qrels_name, trec_name) * 100,
            ...
            # Precision@K
            "P@10": self.calc_trec_metric("-m P.10", qrels_name, trec_name) * 100,
            "P@20": self.calc_trec_metric("-m P.20", qrels_name, trec_name) * 100,
            "P@60": self.calc_trec_metric("-m P.60", qrels_name, trec_name) * 100,
        }
