...
class VLLMCompletion(object):
    def __init__(
            self,
            # model_name="/mnt/nvme0n1/zcl/IR/Think_QE/DeepSeek-R1-Distill-Qwen-14B",
            # model_name="/mnt/nvme0n1/zcl/IR/Think_QE/Meta-Llama-3.1-8B-Instruct",
            model_name="/mnt/nvme0n1/zcl/IR/Think_QE/Qwen2.5-Math-7B",
            eos_token="<|endoftext|>",
